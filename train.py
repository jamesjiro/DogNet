...
def train(epochs=2000, mbsize=64, lr=0.0001):
    ...
    for epoch in range(epochs):
        ...
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                # Set the fc layers to requires_grad for training
                net.inception.fc.requires_grad = True
                net.fc2.requires_grad = True
                loader = train_loader
            else:
                # Disable tracking for validation
                net.inception.fc.requires_grad = False
            ...
            for i, data in enumerate(loader):
                ...
                # forward to compute output and loss
                output = net(inputs)
